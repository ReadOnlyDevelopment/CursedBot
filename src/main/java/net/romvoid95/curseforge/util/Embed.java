...
import net.romvoid95.curseforge.util.txtmark.StringProcessor;
...
public class Embed {
	...
	private static String formatChangelog(final CurseFile file) throws CurseException {
		processor.setInputToProcess(file.changelog().html());
		String string = processor.runProcessor();
		String out = "";
